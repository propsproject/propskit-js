...
proto.pending_props_pb.EarningDetails.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    amountEarned: jspb.Message.getFieldWithDefault(msg, 2, 0),
    amountSettled: jspb.Message.getFieldWithDefault(msg, 3, 0),
...
/**
 * optional int64 amount_earned = 2;
 * @return {number}
 */
...
/**
 * optional int64 amount_settled = 3;
 * @return {number}
 */
